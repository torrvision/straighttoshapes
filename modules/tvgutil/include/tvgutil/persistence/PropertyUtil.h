...
struct PropertyUtil
{
  ...
  /**
   * \brief Attempts to load a property tree from a JSON file.
   *
   * \param filename                                 The name of the file.
   * \return                                         The property tree.
   * \throws boost::property_tree::json_perser_error If the load fails.
   */
  static boost::property_tree::ptree load_properties_from_json(const std::string& filename);
