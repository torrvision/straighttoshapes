...
detection_layer parse_detection(list *options, size_params params)
{
    ...
    int shapeparams = option_find_int(options, "shapeparams", 0);
    int classes = option_find_int(options, "classes", 1);
    int rescore = option_find_int(options, "rescore", 0);
    int num = option_find_int(options, "num", 1);
    int side = option_find_int(options, "side", 7);
    detection_layer layer = make_detection_layer(params.batch, params.inputs, num, side, classes, coords, shapeparams, rescore);
    ...
    layer.shape_scale = option_find_float(options, "shape_scale", 0.1);
